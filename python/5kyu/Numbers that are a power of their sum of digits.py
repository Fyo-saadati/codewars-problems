...
is equal to 81 (nine squared). 
Eighty one (81), is the first number in having this property (not considering 
numbers of one digit). 
...
We 13:52521875, need to make a function that receives a number as argument n 
